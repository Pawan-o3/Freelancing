...
const Freelancer = () => {
  ...
  const fetchUserData = async(id) =>{
      axios.get(`${API_BASE_URL}/fetch-freelancer/${id}`).then(
        (response)=>{
  ...
  const updateUserData = async() =>{
    axios.post(`${API_BASE_URL}/update-freelancer`, {freelancerId, updateSkills: updateSkills, description: updateDescription}).then(
        (response)=>{
          fetchUserData();
  ...
  const fetchApplications = async() =>{
    await axios.get(`${API_BASE_URL}/fetch-applications`).then(
      (response)=>{
